...
def main() -> None:
    ...
    parser.add_argument("--script-mode", default="train", choices=["train", "swing-test", "swing-walk-forward", "xgboost-baseline"], help="src.main --mode to run inside the pod (default: train)")
